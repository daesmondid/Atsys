...
/**
 * Servlet implementation class LogicBoard
 */
@WebServlet("/LogicBoard")
public class LogicBoard extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view = request.getRequestDispatcher("/LogicBoard.jsp");
