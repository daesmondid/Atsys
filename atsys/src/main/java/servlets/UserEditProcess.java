...
/**
 * Servlet implementation class UserEditProcess
 */
@WebServlet("/UserEditProcess")
public class UserEditProcess extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (password.equals(passwordver)) {
			...
			response.getWriter().append("{ \"alert\": \"success\", \"message\": \"User Successfully Updated\" }");
