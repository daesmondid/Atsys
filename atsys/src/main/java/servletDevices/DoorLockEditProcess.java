...
/**
 * Servlet implementation class DoorLockEditProcess
 */
@WebServlet("/DoorLockEditProcess")
public class DoorLockEditProcess extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DoorLockEditProcess() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		new dao.DoorLock().edit(new models.DoorLock(id, name, deviceId, pin, logicBoard, lockStatus));
