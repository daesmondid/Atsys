...
/**
 * Servlet implementation class GarageDoorDelete
 */
@WebServlet("/GarageDoorDeleteProcess")
public class GarageDoorDeleteProcess extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GarageDoorDeleteProcess() {
        super();
