...
/**
 * Servlet implementation class ClimateDetail
 */
@WebServlet("/ClimateDetail")
public class ClimateDetail extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		new dao.LogicBoard().get(new dao.Climate().get(id).getLogicBoard().getId()).checkConnection();
		...
		request.setAttribute("climate", new dao.Climate().get(id));
		request.setAttribute("ticketList", new dao.Ticket().list());
		RequestDispatcher view = request.getRequestDispatcher("/ClimateDetail.jsp");
