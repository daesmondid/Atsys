...
/**
 * Servlet implementation class ClimateDelete
 */
@WebServlet("/ClimateDeleteProcess")
public class ClimateDeleteProcess extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ClimateDeleteProcess() {
        super();
