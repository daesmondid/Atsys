					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="contactFormModalLabel">Edit User</h4>
							</div>
								...
								<div class="contact-widget">
									...
									<form class="nobottommargin" id="template-contactform" name="template-contactform" action="UserEditProcess?id=${requestScope.user.id}" method="post">
										...
										<div class="col_two_third">
											...
											<input type="text" id="template-contactform-name" name="name" value="${requestScope.user.name}" class="required sm-form-control" />
										</div>
										...
										<div class="col_half">
											<label for="template-contactform-password">Password <small>*</small></label>
											<input type="password" id="template-contactform-password" name="password" value="${requestScope.user.password}" class="required sm-form-control" />
										</div>
										
										<div class="col_half col_last">
											<label for="template-contactform-passwordver">Re-Type Password <small>*</small></label>
											<input type="password" id="template-contactform-passwordver" name="passwordver" value="${requestScope.user.password}" class="required sm-form-control" />
										</div>
										...
										<div class="col_full">
											...
											<input type="email" id="template-contactform-email" name="email" value="${requestScope.user.email}" class="required email sm-form-control" />
										</div>
										
										<div class="clear"></div>
										
										<div class="col_half">
											<label for="template-contactform-mobile">Mobile Phone</label>
											<input type="text" id="template-contactform-mobile" name="mobilePhone" value="${requestScope.user.mobilePhone}" class="sm-form-control" />
										</div>
										
										<div class="col_half col_last">
											<label for="template-contactform-phone">Home Phone</label>
											<input type="text" id="template-contactform-phone" name="homePhone" value="${requestScope.user.homePhone}" class="sm-form-control" />
										</div>
										...
										<div class="col_full">
											...
											<textarea class="required sm-form-control" id="template-contactform-address" name="address" rows="6" cols="30">${requestScope.user.address}</textarea>
										</div>
								...
								<div class="col-md-12">
									...
									<div class="tabs tabs-alt clearfix" id="tabs-profile">
										...
										<ul class="tab-nav clearfix">
											<li><a href="#tab-feeds"><i class="icon-desktop"></i> Credential</a></li>
											<li><a href="#tab-posts"><i class="icon-phone3"></i> Contact</a></li>
												...
												<div class="table-responsive">
													<table class="table table-bordered">
													  ...
													  <tbody>
														...
														<tr>
														  <td>Mobile Phone</td>
														  <td>${requestScope.user.mobilePhone}</td>
														</tr>
														<tr>
														  <td>Home Phone</td>
														  <td>${requestScope.user.homePhone}</td>
														</tr>
														<tr>
														  <td>Address</td>
