...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<div class="container clearfix">
						...
						<div class="modal-body">
							...
							<div class="contact-widget">
								...
								<form class="nobottommargin" id="template-contactform"
									...
									action="UserEditProcess?id=${requestScope.user.id}"
									method="post">
									...
									<div class="col_one_third col_last">
										...
										<select id="template-contactform-usertype" name="userType"
											class="required sm-form-control" style="height: 40px;">
											<option value="">-- Select One --</option>
											<c:forEach items="${userTypeList}" var="userType">
												<c:choose>
													<c:when
														test="${fn:containsIgnoreCase(userType, requestScope.user.userType)}">
									...
									<div class="col_half col_last">
										<label for="template-contactform-passwordver">Re-Type
											Password <small>*</small>
										</label> <input type="password" id="template-contactform-passwordver"
											name="passwordver" value="${requestScope.user.password}"
											class="required sm-form-control" />
									</div>
									...
									<div class="col_half">
										...
										<input type="text" id="template-contactform-mobile"
											name="mobilePhone" value="${requestScope.user.mobilePhone}"
											class="sm-form-control" />
									</div>

									<div class="col_half col_last">
										<label for="template-contactform-phone">Home Phone</label> <input
											type="text" id="template-contactform-phone" name="homePhone"
											value="${requestScope.user.homePhone}"
											class="sm-form-control" />
									</div>
									...
									<div class="col_full">
										...
										<textarea class="required sm-form-control"
											id="template-contactform-address" name="address" rows="6"
											cols="30">${requestScope.user.address}</textarea>
									</div>
			...
			<a href="UserDeleteProcess?id=${requestScope.user.id}"
				class="button button-rounded button-mini nomargin"
							...
							<div class="col-md-12">
								...
								<div class="tabs tabs-alt clearfix" id="tabs-profile">
									...
									<ul class="tab-nav clearfix">
										<li><a href="#tab-feeds"><i class="icon-desktop"></i>
												Credential</a></li>
										<li><a href="#tab-posts"><i class="icon-phone3"></i>
												Contact</a></li>
