		...
		<section id="content">
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="col_one_third col_last" data-animate="bounceIn" data-delay="900">
						<div class="feature-box fbox-center fbox-light fbox-effect">
							<div class="fbox-icon">
					...
					<div class="col_one_third" data-animate="bounceIn" data-delay="1500">
						<div class="feature-box fbox-center fbox-light fbox-effect">
							<div class="fbox-icon">
								<a href="ClientAppliances"><i class="icon-line2-screen-desktop i-alt"></i></a>
							</div>
							<h3>Appliances</h3>
						</div>
					</div>
					
					<div class="col_one_third col_last" data-animate="bounceIn" data-delay="1800">
						<div class="feature-box fbox-center fbox-light fbox-effect">
							<div class="fbox-icon">
