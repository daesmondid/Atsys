						...
						<c:forEach items="${climateList}" var="climate" varStatus="loop">
							...
							<div class="col-md-4 col-sm-6 bottommargin-sm"
								...
								<div class="white-section">
									<label><c:out value="${climate.name}"></c:out></label> <br />
									<span class="label label-success"
										style="position: absolute; right: 35px; top: 25px;">Online</span>
									<div class="rounded-skill" data-color="#020b48" data-size="100"
										data-percent="${(climate.temperature / 30.0) * 100}"
										data-width="4" data-speed="3000" data-delay="2000"
										style="margin-right: 20px;">
										<div class="counter counter-inherit">
											<span data-from="1"
												data-to="<c:out value="${climate.temperature}"></c:out>"
												data-refresh-interval="50" data-speed="2500"></span>&deg;C
=======
						<div class="row common-height clearfix">
						
							<c:forEach items="${list}" var="climate" varStatus="loop">
								...
								<div class="col-md-4 col-sm-6 bottommargin-sm" data-animate="fadeInRight" data-delay="${500 + (200 * loop.index)}">
									<div class="white-section">
										...
										<div class="rounded-skill" data-color="#020b48" data-size="100" data-percent="${(climate.temperature / 30.0) * 100}" data-width="4" data-speed="3000" data-delay="2000" style="margin-right: 20px;">
											<div class="counter counter-inherit"><span data-from="1" data-to="<c:out value="${climate.temperature}"></c:out>" data-refresh-interval="50" data-speed="2500"></span>&deg;C</div>
>>>>>>> parent of 5debfc1... Formatted Web Content Folder
										</div>
										<a href="#" class="button button-xlarge button-dark button-rounded tright">+</a>
										<a href="#" class="button button-xlarge button-dark button-rounded tright">-</a>
										<center>
											<h4 style="margin-bottom: 10px;"><span style="color: #999;">Power</span> 
											<c:choose>
												  <c:when test="${climate.powerStatus == 0}">
												    OFF
												  </c:when>
												  <c:when test="${climate.powerStatus == 1}">
												    ON
												  </c:when>
												</c:choose>
											</h4>
