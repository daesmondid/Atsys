						...
						<c:forEach items="${appliancesList}" var="appliances" varStatus="loop">
							<div class="col-md-4 col-sm-6 bottommargin-sm"
								...
								<div class="white-section">
									<label><c:out value="${appliances.name}"></c:out></label> <br />
									<center>
										<h4 style="margin-bottom: 10px;">
											<span style="color: #999;">Power</span>
=======
						<c:forEach items="${list}" var="appliances" varStatus="loop">
...
>>>>>>> parent of 5debfc1... Formatted Web Content Folder
											<c:choose>
												  <c:when test="${appliances.powerStatus == 0}">
												    OFF
												  </c:when>
												  <c:when test="${appliances.powerStatus == 1}">
												    ON
												  </c:when>
												</c:choose>
											</h4>
