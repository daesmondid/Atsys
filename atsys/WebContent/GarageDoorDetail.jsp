	...
	<div id="wrapper" class="clearfix">
		...
		<section id="page-title">
			...
			<div class="container clearfix">
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="contactFormModalLabel">Edit Garage Door Device</h4>
							</div>
								...
								<div class="contact-widget">
									...
									<form class="nobottommargin" id="template-contactform" name="template-contactform" action="GarageDoorEditProcess?id=${requestScope.garageDoor.id}" method="post">
										...
										<div class="col_full">
											...
											<input type="text" id="template-contactform-name" name="name" value="${requestScope.garageDoor.name}" class="required sm-form-control" />
										</div>
										...
										<div class="col_two_third">
											...
											<select id="template-contactform-logicboard" name="logicBoardId" class="required sm-form-control" style="height: 40px;">
												...
												<c:forEach items="${logicBoardList}" var="logicBoard">
													<c:choose>
														<c:when test="${logicBoard.id == requestScope.garageDoor.logicBoard.id}">
										...
										<div class="col_one_third col_last">
											...
											<input type="text" id="template-contactform-pin" name="pin" value="${requestScope.garageDoor.pin}" class="required sm-form-control" />
										</div>
				...
				<a href="GarageDoorDeleteProcess?id=${requestScope.garageDoor.id}" class="button button-rounded button-mini nomargin" style="margin-top: 20px !important;">Delete</a>
				<ol class="breadcrumb">
					<li>Devices</li>
					<li><a href="GarageDoor">Garage Door Device List</a></li>
					<li class="active">Garage Door Device ${requestScope.garageDoor.id} Detail</li>
				</ol>
			</div>
					...
					<div class="row clearfix">
						...
						<div>
							...
							<div class="heading-block noborder">
								<h3>${requestScope.garageDoor.name}</h3>
								<span>${requestScope.garageDoor.logicBoard.user.name}</span>
							</div>
								...
								<div class="col-md-12">
									...
									<div class="tabs tabs-alt clearfix" id="tabs-profile">
										...
										<ul class="tab-nav clearfix">
											<li><a href="#tab-feeds"><i class="icon-line-columns"></i> General</a></li>
											...
											<div class="tab-content clearfix" id="tab-feeds">
												...
												<div class="table-responsive">
													<table class="table table-bordered">
													  ...
													  <tbody>
														<tr>
														  <td>Garage Door ID</td>
														  <td>${requestScope.garageDoor.id}</td>
														</tr>
														<tr>
														  <td>Device ID</td>
														  <td>${requestScope.garageDoor.deviceId}</td>
														</tr>
														<tr>
														  <td>Name</td>
														  <td>${requestScope.garageDoor.name}</td>
														</tr>
														<tr>
														  <td>User</td>
														  <td><a href="UserDetail?id=${requestScope.garageDoor.logicBoard.user.id}" style="text-decoration: underline !important;">${requestScope.garageDoor.logicBoard.user.name}</a></td>
														</tr>
													  </tbody>
													</table>
												  </div>
												...
												<div class="table-responsive">
													<table class="table table-bordered">
													  ...
													  <tbody>
														<tr>
														  <td>Board ID</td>
														  <td>${requestScope.garageDoor.logicBoard.id}</td>
														</tr>
														<tr>
														  <td>Board Name</td>
														  <td>${requestScope.garageDoor.logicBoard.name}</td>
														</tr>
														<tr>
														  <td>Board IP Address</td>
														  <td>${requestScope.garageDoor.logicBoard.address}</td>
														</tr>
														<tr>
														  <td>Device Pin Array</td>
														  <td>${requestScope.garageDoor.pin}</td>
														</tr>
														<tr>
														  <td>Connection Status</td>
														  <c:forEach items="${connectionStatusList}" var="connectionStatus">
															  <c:choose>
																  <c:when test="${fn:containsIgnoreCase(connectionStatus, requestScope.garageDoor.logicBoard.connectionStatus)}">
												...
												<div class="table-responsive">
													...
													<table id="datatable1" class="table table-striped table-bordered" cellspacing="0" width="100%">
														...
														<c:forEach items="${ticketList}" var="ticket">
															<c:choose>
																<c:when test="${ticket.deviceId == requestScope.garageDoor.deviceId}">
