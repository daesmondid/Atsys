...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<div class="container clearfix">
						...
						<div class="modal-body">
							...
							<div class="contact-widget">
								...
								<form class="nobottommargin" id="template-contactform"
									...
									action="GarageDoorEditProcess?id=${requestScope.garageDoor.id}"
									method="post">
									...
									<div class="col_full">
										...
										<input type="text" id="template-contactform-name" name="name"
											value="${requestScope.garageDoor.name}"
									...
									<div class="col_two_third">
										<label for="template-contactform-logicboard">Logic
											...
											<c:forEach items="${logicBoardList}" var="logicBoard">
												<c:choose>
													<c:when
														test="${logicBoard.id == requestScope.garageDoor.logicBoard.id}">
									...
									<div class="col_one_third col_last">
										<label for="template-contactform-pin">Board Pin Array
											...
											value="${requestScope.garageDoor.pin}"
											class="required sm-form-control" />
									</div>
			...
			<a href="GarageDoorDeleteProcess?id=${requestScope.garageDoor.id}"
				class="button button-rounded button-mini nomargin"
				style="margin-top: 20px !important;">Delete</a>
			<ol class="breadcrumb">
				<li>Devices</li>
				<li><a href="GarageDoor">Garage Door Device List</a></li>
				<li class="active">Garage Door Device
					${requestScope.garageDoor.id} Detail</li>
			</ol>
		</div>
							...
							<div class="col-md-12">
								...
								<div class="tabs tabs-alt clearfix" id="tabs-profile">
									...
									<ul class="tab-nav clearfix">
										<li><a href="#tab-feeds"><i class="icon-line-columns"></i>
												General</a></li>
												...
												<table class="table table-bordered">
													...
													<tbody>
														...
														<tr>
															<td>User</td>
															<td><a
																href="UserDetail?id=${requestScope.garageDoor.logicBoard.user.id}"
																style="text-decoration: underline !important;">${requestScope.garageDoor.logicBoard.user.name}</a></td>
														</tr>
													</tbody>
												</table>
											</div>
													...
													<tbody>
														...
														<tr>
															...
															<c:forEach items="${connectionStatusList}"
																...
																<c:choose>
																	<c:when
																		test="${fn:containsIgnoreCase(connectionStatus, requestScope.garageDoor.logicBoard.connectionStatus)}">
												...
												<table id="datatable1"
													...
													<tbody>
														<c:forEach items="${ticketList}" var="ticket">
															<c:choose>
																<c:when
																	test="${ticket.deviceId == requestScope.garageDoor.deviceId}">
																	<tr
