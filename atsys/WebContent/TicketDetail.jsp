...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<div class="container clearfix">
						...
						<div class="modal-body">
							...
							<div class="contact-widget">
								...
								<form class="nobottommargin" id="template-contactform"
									...
									action="TicketEditProcess?id=${requestScope.ticket.id}"
									method="post">
									...
									<div class="col_full">
										...
										<input type="text" id="template-contactform-name" name="name"
											value="${requestScope.ticket.name}"
									...
									<div class="col_one_third">
										<label for="template-contactform-status">Ticket Status
											<small>*</small>
										</label> <select id="template-contactform-status" name="ticketStatus"
											class="required sm-form-control" style="height: 40px;">
											<option value="">-- Select One --</option>
											<c:forEach items="${ticketStatusList}" var="ticketStatus">
												<c:choose>
													<c:when
														test="${fn:containsIgnoreCase(ticketStatus, requestScope.ticket.ticketStatus)}">
									...
									<div class="col_two_third col_last">
										<label for="template-contactform-device">Related
											Device</label> <select id="template-contactform-device"
											name="deviceId" class="sm-form-control" style="height: 40px;">
											<option value="">-- Select One --</option>
											<c:forEach items="${deviceList}" var="device">
												<c:choose>
													<c:when
														test="${device.deviceId == requestScope.ticket.deviceId}">
			...
			<a href="TicketDeleteProcess?id=${requestScope.ticket.id}"
				class="button button-rounded button-mini nomargin"
							...
							<div class="col-md-12">
								...
								<div class="tabs tabs-alt clearfix" id="tabs-profile">
									...
									<ul class="tab-nav clearfix">
										<li><a href="#tab-feeds"><i class="icon-line-paper"></i>
												General</a></li>
										<li><a href="#tab-replies"><i
												class="icon-line-speech-bubble"></i> Messages</a></li>
									</ul>
												...
												<table class="table table-bordered">
													...
													<tbody>
														...
														<tr>
															<td>User</td>
															<td><a
																href="UserDetail?id=${requestScope.ticket.user.id}"
																style="text-decoration: underline !important;">${requestScope.ticket.user.name}</a></td>
														</tr>
														<tr>
										...
										<div class="tab-content clearfix" id="tab-replies">
											...
											<ol class="commentlist noborder nomargin nopadding clearfix">
												<c:forEach items="${messageList}" var="message">
													<c:choose>
														<c:when
															test="${message.ticket.id == requestScope.ticket.id}">
																...
																<div id="comment-1" class="comment-wrap clearfix">
																	...
																	<div class="comment-content clearfix">
																		<div class="comment-author">
																			<c:out value="${message.user.name}"></c:out>
																			<span><c:out value="${message.timestamp}"></c:out></span>
																		</div>
																		<p>
											...
											<a href="#" data-toggle="modal"
												data-target="#contactFormModalMessage"
												class="button btn-block button-rounded topmargin center"
												style="margin-right: 5px !important;">New Message</a>

											<div class="modal fade" id="contactFormModalMessage"
													...
													<div class="modal-content">
														...
														<div class="modal-body">
															...
															<div class="contact-widget">
																...
																<form class="nobottommargin" id="template-contactform"
																	name="template-contactform"
																	action="MessageAddProcess?id=${requestScope.ticket.id}"
																	method="post">

																	<div class="form-process"></div>

																	<input type="hidden" name="name"
																		value="${requestScope.ticket.name}"> <input
																		type="hidden" name="deviceId"
																		value="${requestScope.ticket.deviceId}">

																	<div class="col_full">
																		<label for="template-contactform-status">Ticket
																			Status <small>*</small>
																		</label> <select id="template-contactform-status"
																			name="ticketStatus" class="required sm-form-control"
																			style="height: 40px;">
																			<option value="">-- Select One --</option>
																	...
																	<div class="col_full">
																		<label for="template-contactform-content">Message
																			<small>*</small>
																		</label>
																		<textarea class="required sm-form-control"
																			id="template-contactform-content" name="content"
																	...
																	<div class="col_full">
																		<button class="button button-3d nomargin"
																			...
																			name="template-contactform-submit" value="submit">Send</button>
																	</div>
