...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<div class="container clearfix">
						...
						<div class="modal-body">
							...
							<div class="contact-widget">
								...
								<form class="nobottommargin" id="template-contactform"
									...
									action="ClimateEditProcess?id=${requestScope.climate.id}"
									method="post">
									...
									<div class="col_full">
										...
										<input type="text" id="template-contactform-name" name="name"
											value="${requestScope.climate.name}"
									...
									<div class="col_two_third">
										<label for="template-contactform-logicboard">Logic
											...
											<c:forEach items="${logicBoardList}" var="logicBoard">
												<c:choose>
													<c:when
														test="${logicBoard.id == requestScope.climate.logicBoard.id}">
									...
									<div class="col_one_third col_last">
										<label for="template-contactform-pin">Board Pin Array
											...
											value="${requestScope.climate.pin}"
											class="required sm-form-control" />
									</div>
			...
			<a href="ClimateDeleteProcess?id=${requestScope.climate.id}"
				class="button button-rounded button-mini nomargin"
				style="margin-top: 20px !important;">Delete</a>
			<ol class="breadcrumb">
				<li>Devices</li>
				<li><a href="Climate">Climate Device List</a></li>
				<li class="active">Climate Device ${requestScope.climate.id}
					Detail</li>
			</ol>
		</div>
							...
							<div class="col-md-12">
								...
								<div class="tabs tabs-alt clearfix" id="tabs-profile">
									...
									<ul class="tab-nav clearfix">
										<li><a href="#tab-feeds"><i class="icon-line-sun"></i>
												General</a></li>
												...
												<table class="table table-bordered">
													...
													<tbody>
														...
														<tr>
															<td>User</td>
															<td><a
																href="UserDetail?id=${requestScope.climate.logicBoard.user.id}"
																style="text-decoration: underline !important;">${requestScope.climate.logicBoard.user.name}</a></td>
														</tr>
													</tbody>
												</table>
											</div>
													...
													<tbody>
														...
														<tr>
															...
															<c:forEach items="${connectionStatusList}"
																...
																<c:choose>
																	<c:when
																		test="${fn:containsIgnoreCase(connectionStatus, requestScope.climate.logicBoard.connectionStatus)}">
												...
												<table id="datatable1"
													...
													<tbody>
														<c:forEach items="${ticketList}" var="ticket">
															<c:choose>
																<c:when
																	test="${ticket.deviceId == requestScope.climate.deviceId}">
																	<tr
