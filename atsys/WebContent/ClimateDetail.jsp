					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="contactFormModalLabel">Edit Climate Device</h4>
							</div>
								...
								<div class="contact-widget">
									...
									<form class="nobottommargin" id="template-contactform" name="template-contactform" action="ClimateEditProcess" method="post">
										...
										<div class="col_full">
											...
											<input type="text" id="template-contactform-name" name="name" value="${requestScope.climate.name}" class="required sm-form-control" />
										</div>
										...
										<div class="col_two_third">
											...
											<select id="template-contactform-logicboard" name="logicBoardId" class="required sm-form-control" style="height: 40px;">
												...
												<c:forEach items="${logicBoardList}" var="logicBoard">
													<c:choose>
														<c:when test="${logicBoard.id == requestScope.climate.logicBoard.id}">
										...
										<div class="col_one_third col_last">
											...
											<input type="text" id="template-contactform-pin" name="pin" value="${requestScope.climate.pin}" class="required sm-form-control" />
										</div>
