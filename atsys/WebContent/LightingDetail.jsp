		...
		<section id="page-title">
			...
			<div class="container clearfix">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<div class="contact-widget">
									...
									<form class="nobottommargin" id="template-contactform" name="template-contactform" action="LightingEditProcess?id=${requestScope.lighting.id}" method="post">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Lighting ${requestScope.lighting.id} Device Detail</li>
				</ol>
			</div>
								...
								<div class="col-md-12">
									...
									<div class="tabs tabs-alt clearfix" id="tabs-profile">
										...
										<ul class="tab-nav clearfix">
											<li><a href="#tab-feeds"><i class="icon-bulb"></i> General</a></li>
												...
												<div class="table-responsive">
													<table class="table table-bordered">
													  ...
													  <tbody>
														...
														<tr>
														  <td>User</td>
														  <td><a href="UserDetail?id=${requestScope.lighting.logicBoard.user.id}" style="text-decoration: underline !important;">${requestScope.lighting.logicBoard.user.name}</a></td>
														</tr>
													  </tbody>
													</table>
												  </div>
													  ...
													  <tbody>
														...
														<tr>
														  ...
														  <c:forEach items="${connectionStatusList}" var="connectionStatus">
															  <c:choose>
																  <c:when test="${fn:containsIgnoreCase(connectionStatus, requestScope.lighting.logicBoard.connectionStatus)}">
												...
												<div class="table-responsive">
													...
													<table id="datatable1" class="table table-striped table-bordered" cellspacing="0" width="100%">
														...
														<c:forEach items="${ticketList}" var="ticket">
															<c:choose>
																<c:when test="${ticket.deviceId == requestScope.lighting.deviceId}">
