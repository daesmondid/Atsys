...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<div class="container clearfix">
						...
						<div class="modal-body">
							...
							<div class="contact-widget">
								...
								<form class="nobottommargin" id="template-contactform"
									...
									action="LightingEditProcess?id=${requestScope.lighting.id}"
									method="post">
									...
									<div class="col_full">
										...
										<input type="text" id="template-contactform-name" name="name"
											value="${requestScope.lighting.name}"
									...
									<div class="col_two_third">
										<label for="template-contactform-logicboard">Logic
											...
											<c:forEach items="${logicBoardList}" var="logicBoard">
												<c:choose>
													<c:when
														test="${logicBoard.id == requestScope.lighting.logicBoard.id}">
									...
									<div class="col_one_third col_last">
										<label for="template-contactform-pin">Board Pin Array
											...
											value="${requestScope.lighting.pin}"
											class="required sm-form-control" />
									</div>
			...
			<a href="LightingDeleteProcess?id=${requestScope.lighting.id}"
				class="button button-rounded button-mini nomargin"
				style="margin-top: 20px !important;">Delete</a>
			<ol class="breadcrumb">
				<li>Devices</li>
				<li><a href="Lighting">Lighting Device List</a></li>
				<li class="active">Lighting ${requestScope.lighting.id} Device
					Detail</li>
			</ol>
		</div>
				...
				<div class="row clearfix">
					...
					<div>
						...
						<div class="heading-block noborder">
							...
							<span>${requestScope.lighting.logicBoard.user.name}</span>
						</div>
							...
							<div class="col-md-12">
								...
								<div class="tabs tabs-alt clearfix" id="tabs-profile">
									...
									<ul class="tab-nav clearfix">
										<li><a href="#tab-feeds"><i class="icon-bulb"></i>
												General</a></li>
											...
											<div class="table-responsive">
												<table class="table table-bordered">
													...
													<tbody>
														...
														<tr>
															<td>Name</td>
															<td>${requestScope.lighting.name}</td>
														</tr>
														<tr>
															<td>User</td>
															<td><a
																href="UserDetail?id=${requestScope.lighting.logicBoard.user.id}"
																style="text-decoration: underline !important;">${requestScope.lighting.logicBoard.user.name}</a></td>
														</tr>
													</tbody>
												</table>
											</div>
											...
											<div class="table-responsive">
												<table class="table table-bordered">
													...
													<tbody>
														...
														<tr>
															<td>Board Name</td>
															<td>${requestScope.lighting.logicBoard.name}</td>
														</tr>
														<tr>
															<td>Board IP Address</td>
															<td>${requestScope.lighting.logicBoard.address}</td>
														</tr>
														<tr>
														...
														<tr>
															...
															<c:forEach items="${connectionStatusList}"
																...
																<c:choose>
																	<c:when
																		test="${fn:containsIgnoreCase(connectionStatus, requestScope.lighting.logicBoard.connectionStatus)}">
												...
												<table id="datatable1"
													...
													<tbody>
														<c:forEach items="${ticketList}" var="ticket">
															<c:choose>
																<c:when
																	test="${ticket.deviceId == requestScope.lighting.deviceId}">
																	<tr
