...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<div class="container clearfix">
						...
						<div class="modal-body">
							...
							<div class="contact-widget">
								...
								<form class="nobottommargin" id="template-contactform"
									...
									action="AudioSystemEditProcess?id=${requestScope.audioSystem.id}"
									method="post">
									...
									<div class="col_full">
										...
										<input type="text" id="template-contactform-name" name="name"
											value="${requestScope.audioSystem.name}"
									...
									<div class="col_two_third">
										<label for="template-contactform-logicboard">Logic
											...
											<c:forEach items="${logicBoardList}" var="logicBoard">
												<c:choose>
													<c:when
														test="${logicBoard.id == requestScope.audioSystem.logicBoard.id}">
									...
									<div class="col_one_third col_last">
										<label for="template-contactform-pin">Board Pin Array
											...
											value="${requestScope.audioSystem.pin}"
											class="required sm-form-control" />
									</div>
			...
			<a href="AudioSystemDeleteProcess?id=${requestScope.audioSystem.id}"
				class="button button-rounded button-mini nomargin"
				style="margin-top: 20px !important;">Delete</a>
			<ol class="breadcrumb">
				<li>Devices</li>
				<li><a href="AudioSystem">Audio System Device List</a></li>
				<li class="active">Audio System Device
					${requestScope.audioSystem.id} Detail</li>
			</ol>
		</div>
							...
							<div class="col-md-12">
								...
								<div class="tabs tabs-alt clearfix" id="tabs-profile">
									...
									<ul class="tab-nav clearfix">
										<li><a href="#tab-feeds"><i class="icon-music"></i>
												General</a></li>
												...
												<table class="table table-bordered">
													...
													<tbody>
														...
														<tr>
															<td>User</td>
															<td><a
																href="UserDetail?id=${requestScope.audioSystem.logicBoard.user.id}"
																style="text-decoration: underline !important;">${requestScope.audioSystem.logicBoard.user.name}</a></td>
														</tr>
													</tbody>
												</table>
											</div>
													...
													<tbody>
														...
														<tr>
															...
															<c:forEach items="${connectionStatusList}"
																...
																<c:choose>
																	<c:when
																		test="${fn:containsIgnoreCase(connectionStatus, requestScope.audioSystem.logicBoard.connectionStatus)}">
												...
												<table id="datatable1"
													...
													<tbody>
														<c:forEach items="${ticketList}" var="ticket">
															<c:choose>
																<c:when
																	test="${ticket.deviceId == requestScope.audioSystem.deviceId}">
																	<tr
