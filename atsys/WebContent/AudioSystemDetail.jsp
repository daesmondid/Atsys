	...
	<div id="wrapper" class="clearfix">
		...
		<section id="page-title">
			...
			<div class="container clearfix">
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="contactFormModalLabel">Edit Audio System Device</h4>
							</div>
							<div class="modal-body">

								<div class="contact-widget">
									<div class="contact-form-result"></div>
									<form class="nobottommargin" id="template-contactform" name="template-contactform" action="AudioSystemEditProcess?id=${requestScope.audioSystem.id}" method="post">

										<div class="form-process"></div>

										<div class="col_full">
											<label for="template-contactform-name">Name <small>*</small></label>
											<input type="text" id="template-contactform-name" name="name" value="${requestScope.audioSystem.name}" class="required sm-form-control" />
										</div>
										...
										<div class="col_two_third">
											...
											<select id="template-contactform-logicboard" name="logicBoardId" class="required sm-form-control" style="height: 40px;">
												...
												<c:forEach items="${logicBoardList}" var="logicBoard">
													<c:choose>
														<c:when test="${logicBoard.id == requestScope.audioSystem.logicBoard.id}">
										...
										<div class="col_one_third col_last">
											...
											<input type="text" id="template-contactform-pin" name="pin" value="${requestScope.audioSystem.pin}" class="required sm-form-control" />
										</div>
				...
				<a href="AudioSystemDeleteProcess?id=${requestScope.audioSystem.id}" class="button button-rounded button-mini nomargin" style="margin-top: 20px !important;">Delete</a>
				<ol class="breadcrumb">
					<li>Devices</li>
					<li><a href="AudioSystem">Audio System Device List</a></li>
					<li class="active">Audio System Device ${requestScope.audioSystem.id} Detail</li>
				</ol>
			</div>
					...
					<div class="row clearfix">
						...
						<div>
							...
							<div class="heading-block noborder">
								<h3>${requestScope.audioSystem.name}</h3>
								<span>${requestScope.audioSystem.logicBoard.user.name}</span>
							</div>
								...
								<div class="col-md-12">
									...
									<div class="tabs tabs-alt clearfix" id="tabs-profile">
										...
										<ul class="tab-nav clearfix">
											<li><a href="#tab-feeds"><i class="icon-music"></i> General</a></li>
											...
											<div class="tab-content clearfix" id="tab-feeds">
												...
												<div class="table-responsive">
													<table class="table table-bordered">
													  ...
													  <tbody>
														<tr>
														  <td>Audio System ID</td>
														  <td>${requestScope.audioSystem.id}</td>
														</tr>
														<tr>
														  <td>Device ID</td>
														  <td>${requestScope.audioSystem.deviceId}</td>
														</tr>
														<tr>
														  <td>Name</td>
														  <td>${requestScope.audioSystem.name}</td>
														</tr>
														<tr>
														  <td>User</td>
														  <td><a href="UserDetail?id=${requestScope.audioSystem.logicBoard.user.id}" style="text-decoration: underline !important;">${requestScope.audioSystem.logicBoard.user.name}</a></td>
														</tr>
													  </tbody>
													</table>
												  </div>
												...
												<div class="table-responsive">
													<table class="table table-bordered">
													  ...
													  <tbody>
														<tr>
														  <td>Board ID</td>
														  <td>${requestScope.audioSystem.logicBoard.id}</td>
														</tr>
														<tr>
														  <td>Board Name</td>
														  <td>${requestScope.audioSystem.logicBoard.name}</td>
														</tr>
														<tr>
														  <td>Board IP Address</td>
														  <td>${requestScope.audioSystem.logicBoard.address}</td>
														</tr>
														<tr>
														  <td>Device Pin Array</td>
														  <td>${requestScope.audioSystem.pin}</td>
														</tr>
														<tr>
														  <td>Connection Status</td>
														  <c:forEach items="${connectionStatusList}" var="connectionStatus">
															  <c:choose>
																  <c:when test="${fn:containsIgnoreCase(connectionStatus, requestScope.audioSystem.logicBoard.connectionStatus)}">
												...
												<div class="table-responsive">
													...
													<table id="datatable1" class="table table-striped table-bordered" cellspacing="0" width="100%">
														...
														<c:forEach items="${ticketList}" var="ticket">
															<c:choose>
																<c:when test="${ticket.deviceId == requestScope.audioSystem.deviceId}">
