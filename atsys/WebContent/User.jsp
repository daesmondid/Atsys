					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="contactFormModalLabel">Add New User</h4>
							</div>
							<div class="modal-body">

								<div class="contact-widget">
									<div class="contact-form-result"></div>
									<form class="nobottommargin" id="template-contactform" name="template-contactform" action="UserAddProcess" method="post">
										...
										<div class="col_half">
											...
											<input type="password" id="template-contactform-password" name="password" value="" class="required sm-form-control" />
										</div>
										
										<div class="col_half col_last">
											<label for="template-contactform-passwordver">Re-Type Password <small>*</small></label>
											<input type="password" id="template-contactform-passwordver" name="passwordver" value="" class="required sm-form-control" />
										</div>
										...
										<div class="col_half">
											...
											<input type="text" id="template-contactform-mobile" name="mobilePhone" value="" class="sm-form-control" />
										</div>
										
										<div class="col_half col_last">
											<label for="template-contactform-phone">Home Phone</label>
											<input type="text" id="template-contactform-phone" name="homePhone" value="" class="sm-form-control" />
										</div>
										...
										<div class="col_full">
											...
											<textarea class="required sm-form-control" id="template-contactform-address" name="address" rows="6" cols="30"></textarea>
										</div>
