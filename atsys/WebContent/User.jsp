						...
						<div class="modal-body">
							...
							<div class="contact-widget">
								...
								<form class="nobottommargin" id="template-contactform"
									name="template-contactform" action="UserAddProcess"
									method="post">
									...
									<div class="col_half">
										...
										<input type="password" id="template-contactform-password"
											name="password" value="" class="required sm-form-control" />
									</div>
									...
									<div class="col_half col_last">
										<label for="template-contactform-passwordver">Re-Type
											...
											name="passwordver" value="" class="required sm-form-control" />
									</div>
									...
									<div class="col_full">
										...
										<input type="email" id="template-contactform-email"
											name="email" value="" class="required email sm-form-control" />
									</div>
									...
									<div class="col_half">
										...
										<input type="text" id="template-contactform-mobile"
											name="mobilePhone" value="" class="sm-form-control" />
									</div>
					...
					<table id="datatable1" class="table table-striped table-bordered"
						...
						<tbody>
							<c:forEach items="${userList}" var="user">
								<tr
									onclick="document.location='UserDetail?id=<c:out value="${user.id}"></c:out>'"
									...
									<c:forEach items="${userTypeList}" var="userType">
										<c:choose>
											<c:when
												test="${fn:containsIgnoreCase(userType, user.userType)}">
