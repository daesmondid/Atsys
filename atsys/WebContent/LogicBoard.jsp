						...
						<div class="modal-body">
							...
							<div class="contact-widget">
								...
								<form class="nobottommargin" id="template-contactform"
									name="template-contactform" action="LogicBoardAddProcess"
									method="post">
									...
									<div class="col_half col_last">
										...
										<input type="text" id="template-contactform-ip" name="address"
											value="" class="required sm-form-control" />
									</div>
					...
					<table id="datatable1" class="table table-striped table-bordered"
						...
						<tbody>
							<c:forEach items="${logicBoardList}" var="logicBoard">
								<tr
									onclick="document.location='LogicBoardDetail?id=<c:out value="${logicBoard.id}"></c:out>'"
									...
									<c:forEach items="${connectionStatusList}"
										...
										<c:choose>
											<c:when
												test="${fn:containsIgnoreCase(connectionStatus, logicBoard.connectionStatus)}">
