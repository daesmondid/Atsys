						...
						<div class="modal-body">
							...
							<div class="contact-widget">
								...
								<form class="nobottommargin" id="template-contactform"
									name="template-contactform" action="LightingAddProcess"
									method="post">
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="contactFormModalLabel">Add New Lighting Device</h4>
>>>>>>> parent of 5debfc1... Formatted Web Content Folder
							...
							<div class="modal-body">
								...
								<div class="contact-widget">
									<div class="contact-form-result"></div>
									<form class="nobottommargin" id="template-contactform" name="template-contactform" action="LightingAddProcess" method="post">
