	...
	<div id="wrapper" class="clearfix">
		...
		<div class="content-wrap nopadding">
			...
			<div class="section nopadding nomargin"
				style="width: 100%; height: 100%; position: absolute; left: 0; top: 0; background: #444;"></div>

			<div class="section full-screen nopadding nomargin"
				style="background-color: #020b48">
				<div class="container vertical-middle divcenter clearfix">

					<div class="row center">
						<a href="index.html"><img src="images/logo-dark.svg"
							width="240" alt="Canvas Logo"></a>
					</div>
					...
					<div class="row center dark">
						<small>Copyrights &copy; All Rights Reserved by Atmos
							Indonesia</small>
					</div>
