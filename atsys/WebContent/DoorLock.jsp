						...
						<div class="modal-body">
							...
							<div class="contact-widget">
								...
								<form class="nobottommargin" id="template-contactform"
									name="template-contactform" action="DoorLockAddProcess"
									method="post">
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="contactFormModalLabel">Add New Door Lock Device</h4>
>>>>>>> parent of 5debfc1... Formatted Web Content Folder
							...
							<div class="modal-body">
								...
								<div class="contact-widget">
									<div class="contact-form-result"></div>
									<form class="nobottommargin" id="template-contactform" name="template-contactform" action="DoorLockAddProcess" method="post">
				...
				<ol class="breadcrumb">
					<li>Devices</li>
					<li class="active">Door Lock Device List</li>
				</ol>
			</div>
						...
						<table id="datatable1" class="table table-striped table-bordered" cellspacing="0" width="100%">
							...
							<c:forEach items="${doorLockList}" var="doorLock">
								<tr onclick="document.location='DoorLockDetail?id=<c:out value="${doorLock.id}"></c:out>'" style="cursor: pointer;">
									...
									<td><c:out value="${doorLock.logicBoard.user.name}"></c:out></td>
								</tr>
							</c:forEach>
							</tbody>
						</table>
